...
// Screens proposed for Joey's approval (B5)
const screens = [
...
export function AppShowcase() {
  return (
    <section className="px-6 py-20 md:py-28 overflow-hidden" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-6xl mx-auto">
        <SectionHeader
          eyebrow="The app"
          heading={<>Everything your home needs,<br /><em style={{ fontStyle: 'italic', color: '#E8D26A' }}>in your pocket.</em></>}
          className="mb-16"
        />
          ...
          {screens.map((s, i) => (
            <div key={s.file} className="flex flex-col items-center gap-3">
              <IPhoneFrame
                ...
                style={{ transform: `translateY(${i % 2 === 1 ? '24px' : '0'})` } as React.CSSProperties}
              >
